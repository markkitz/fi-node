var require = {
    ...
    paths: {
        ...
        'angular-cookies': '//ajax.googleapis.com/ajax/libs/angularjs/1.3.11/angular-cookies.min',
        'angular-resource': '//ajax.googleapis.com/ajax/libs/angularjs/1.3.11/angular-resource.min',
        'angular-sanitize': '//ajax.googleapis.com/ajax/libs/angularjs/1.3.11/angular-sanitize.min',
        'angular-animate': '//ajax.googleapis.com/ajax/libs/angularjs/1.3.11/angular-animate.min',
        'angular-file-upload': '../Scripts/angular-file-upload-all.min',
        'diff_match_patch': '../Scripts/diff_match_patch',
        'angular-diff-match-patch': '../Scripts/angular-diff-match-patch',
        ...
        'angular-ui-select': '../plugin/select2/select2',
        'angular-ui-date': '../plugin/angular-ui-date/date'
    ...
    shim: {
        ...
        'angular-diff-match-patch': { deps: ['angular', 'diff_match_patch'] },
        ...
        'angular-ui-date': { deps: ['angular', 'jquery-ui'] }
